    ...
    <div class="ai-layout">
        ...
        <aside class="ai-rail">
            <article class="panel rail-panel" id="ui-todo">
                ...
                <ul class="feature-list">
                    <li>Search module: [DONE] implemented global search for jobs, applicants, and records.</li>
                    <li>Inbox module: [DONE] implemented notification system for status updates and alerts.</li>
                    <li>AI skill-fit: still pending as a potential teammate extension.</li>
                </ul>
            </article>
