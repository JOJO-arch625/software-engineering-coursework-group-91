                ...
                <div class="ai-insights">
                    ...
                    <div class="ai-evidence-box">
                        <div class="ai-meta-grid">
                            ...
                            <span class="status-chip <%= riskClass %>"><%= riskLabel %> - <%= item.getAcceptedCount() %> / 3</span>
                        </div>
                        <p><%= i18n.td(item.getAdvice()) %></p>
                        <span class="ai-source-chip ai-source-<%= item.getSourceMode() %>"><%= i18n.t("ai.assist.generated-by", i18n.t("ai.assist.source.local")) %></span>
                    </div>
                    <% } %>
                </div>
            </div>
